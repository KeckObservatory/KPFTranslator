...
- **<font color="orange">Etalon</font>**: Operational but with reduced flux which is imbalanced between red and green.
...
- **<font color="orange">Exposure Meter Terminated Exposures</font>**: The control system supports exposure meter terminated exposures, however we are still documenting performance on sky.
